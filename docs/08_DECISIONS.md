...
## DEC-10 — Vercel Preview Mode via PREVIEW_MODE=true

**Tanggal:** 2026-07-03

**Konteks:** Perlu menampilkan website di Vercel sebagai demo UI (Preview UI) tanpa akses SQLite database, better-sqlite3 inisialisasi, atau write operations.
